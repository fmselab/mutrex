...
<body>
	...
	<form action="index.jsp">
		...
		<p>
			...
			<INPUT TYPE="radio" NAME="option" VALUE="BASIC" CHECKED>Basic algorithm<BR>
			<INPUT TYPE="radio" NAME="option" VALUE="MONITORING">Use monitoring<BR>
			<INPUT TYPE="radio" NAME="option" VALUE="COLLECTING_NO_LIMIT">Use collecting<BR>
			<!-- the mutations -->
...
<!-- 
			...
			<INPUT TYPE="radio" NAME="pref" VALUE="RANDOM" CHECKED>RANDOM<BR>
			<INPUT TYPE="radio" NAME="pref" VALUE="PREF_POS">Prefer accepted<BR>
			<INPUT TYPE="radio" NAME="pref" VALUE="PREF_NEG">Prefer rejected<BR>
 -->
	</form>
	<hr>
	<h2>MutRex syntax</h2>
	...
	<%
			...
			DSSet ds = MutRex.generateStrings(request.getParameter("regex"), option, request.getParameterValues("mop"));
	%>
	<table>
		<thead>
			<tr>
